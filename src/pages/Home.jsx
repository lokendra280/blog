...
const comments = [
  {
    ...
    name: "रमेश के.सी",
    comment:
      "मैले पनि MR.BIG थोरको एक इन्टरभ्युवबाट जानकारी प्राप्त गरेको थिएँ, तर मलाई लाग्यो कि त्यो पोर्न अभिनेत्रीको बारेमा थियो। यो जस्तो सामान सचमुच अहिष्टो हो। मैले यसलाई मात्र ३ दिनदेखि उपयोग गरेको छु र पहिलोपटक +२ सेन्टिमिटरको परिणाम प्राप्त गरेको छु। यसले मलाई धेरै सन्तुष्टिपूर्ण बनाएको छ! :)",
    coverimgUrl: "",
    date: "०१.०५.२०२३",
  },
  {
    ...
    name: "बिपिन गिरी",
    comment:
      "अजीज, तपाईं अद्भुत हुनुहुन्छ। म सधैं खुशी संग तपाईको ब्लग पढ्छु। हिजो मैले MR.BIG थोर अर्डर गरें, र यो आज डेलिभर गरिनु पर्छ। नतिजा पछि बताउनेछु!",
    coverimgUrl: "",
    date: "०१.०५.२०२३",
  },
  {
  ...
  },
  {
    ...
    name: "राजीव तामाङ",
    comment:
      "म एक महिनाको लागि प्रत्येक दिन MR.BIG थोर प्रयोग गरिरहेको थिएँ। नतिजा मात्र प्रज्वलित छ। 8 सेन्टिमिटर। केटीहरू अब पागल छन्!",
    coverimgUrl:
...

  {
    ...
    name: "अफिक",
    comment:
      "मैले कम्तिमा 3 सेन्टिमिटर प्राप्त गर्न धेरै बकवास प्रयास गरेको छु... मैले MR.BIG थोरको प्रयास नगरेसम्म सबै व्यर्थ थियो। अजिज, धन्यवाद। तपाईं र तपाईंको ब्लगले मेरो जीवनमा आमूल परिवर्तन ल्याएको छ। मैले MR.BIG थोर अर्डर गरें र मेरो लिंग लामो मात्र होइन, मोटो पनि भयो। ७ सेन्टिमिटर लम्बाइ र १.५ चौडाइ।",
    coverimgUrl: "",
    date: "०५.०५.२०२३",
  },
  {
  ...
  },
  {
    ...
    name: "हरिबहादुर गिरी",
    comment:
      "मेरो विवाह लगभग सकिएको थियो र यो पोस्टले मेरो विवाहलाई एक तरिकाले बचाएको छ। MR.BIG थोरले मलाई मेरो लिंग 6 सेन्टिमिटरले मात्र ठूलो बनाउन मद्दत गर्‍यो, तर मेरो शक्तिलाई पनि पुनर्स्थापित गर्‍यो। राम्रो सेक्स सुखी र लामो सम्बन्धको कुञ्जी हो, र हयामर अफ थोर राम्रो सेक्सको कुञ्जी हो",
    coverimgUrl: "",
    date: "०६.०५.२०२३",
  },
  {
    ...
    <div className="bg-[#F5F5F5]">
      <div className="xl:max-w-[820px] px-6 xl:px-0 w-full mx-auto mt-[-68px] ">
        ...
        <div className="bg-white shadow-lg rounded-2xl  mt-[-40px] pt-8 ">
          ...
          <div className="px-10">
            <p className="xl:text-[18px] text-[44px]  leading-[70px] xl:leading-8 font-normal py-[30px]">
              आश्चर्यजनक! 😲 MR.BIG थोरको मात्र एक हप्तामा प्रयोग गरेपछि मेरो
              ...
              थियो। 😎 तिनीहरूले मेरो लिङ्ग धेरै मन पर्यो। अब MR.BIG थोर
              ...
              होइन? MR.BIG थोरको आदेश गर्नुहोस् र आफ्ना सबै इच्छाहरू ७ दिनमा
